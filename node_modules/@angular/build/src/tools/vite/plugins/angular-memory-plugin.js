...
async function loadViteClientCode(file, disableViteTransport = false) {
    const rawContents = await (0, promises_1.readFile)(file, 'utf-8');
    // Normalize CRLF to LF so the string search works on Windows
    const originalContents = rawContents.replace(/\r\n/g, '\n');
